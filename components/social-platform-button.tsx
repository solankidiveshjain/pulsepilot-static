...
export function SocialPlatformButton({ platform, icon, isConnected, onClick }: SocialPlatformButtonProps) {
  return (
    <Button
      variant="outline"
      className={cn(
        "h-auto py-5 relative border-2 transition-all duration-300 shadow-sm hover:shadow-md hover-scale",
